...
const that=window;
console.info(window);
 export const WebVideoCtrl = (function () {
    var m_szWidth = "100%";
    var m_szHeight = "100%";
    var m_options = {
    ...
    var _initPlugin = function (szContainerID) {
      let oPromise = new Promise(function (resolve, reject) {
        ...
        console.info(122121,m_pluginOBJECT);
    ...
    window.I_SupportNoPlugin = function () {
      return false;
    };
    window.I_Resize = function (iWidth, iHeight) {
      return m_pluginOBJECT.JS_Resize(iWidth, iHeight);
    };
    that.I_InitPlugin = function (options) {
    ...
    window.I_InsertOBJECTPlugin = function (szContainerID) {
      return _initPlugin(szContainerID);
    };
    window.I_WriteOBJECT_XHTML = function () {
      return 0;
    };
    window.I_DestroyPlugin = function () {
      let oPromise = new Promise(function (resolve, reject) {
    ...
    window.I_OpenFileDlg = async function (iType) {
      let oPromise = new Promise(function (resolve, reject) {
    ...
    window.I_SetLocalCfg = function (oLocalCofing) {
      let oPromise = new Promise(function (resolve, reject) {
    ...
    window.I_Login = function (
      ...
      let oPromise = new Promise(function (resolve, reject) {
        ...
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          if (options.error) {
            options.error({
    ...
    window.I_Logout = function (szDeviceIdentify) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
    ...
    window.I_GetAudioInfo = function (szDeviceIdentify, options) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_GetDeviceInfo = function (szDeviceIdentify, options) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_GetAnalogChannelInfo = function (szDeviceIdentify, options) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_GetDigitalChannelInfo = function (szDeviceIdentify, options) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_GetZeroChannelInfo = function (szDeviceIdentify, options) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_StartRealPlay = function (szDeviceIdentify, options) {
      ...
      let oPromise = new Promise(function (resolve, reject) {
        ...
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
          console.info("oDeviceInfo",oDeviceInfo)
           var iWndIndex = m_webVideoCtrl.findWndIndexByIndex(newOptions.iWndIndex);
          //var iWndIndex = -1;

          console.info("窗口",iWndIndex)
          if (-1 == iWndIndex) {
            oDeviceInfo.oProtocolInc
    ...
    window.I_StartPlay = function (szDeviceIdentify, options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        var newOptions = { iWndIndex: m_iSelWnd };
        m_utilsInc.extend(newOptions, options);
        var oDeviceInfo = m_deviceSet[iIndex];
        iIndex = m_webVideoCtrl.findWndIndexByIndex(newOptions.iWndIndex);
        if (-1 == iIndex) {
    ...
    window.I_SetSecretKey = function (szSecretKey) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_GetEncryptString = function (szSecretKey) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_Stop = function (options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd };
        ...
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(newOptions.iWndIndex);
        if (iIndex != -1) {
    ...
    window.I_OpenSound = function (iWndIndex) {
      iWndIndex = m_utilsInc.isUndefined(iWndIndex) ? m_iSelWnd : iWndIndex;
      let oPromise = new Promise((resolve, reject) => {
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(iWndIndex);
        if (iIndex != -1) {
          var wndInfo = m_wndSet[iIndex];
          if (!wndInfo.bSound) {
    ...
    window.I_CloseSound = function (iWndIndex) {
      iWndIndex = m_utilsInc.isUndefined(iWndIndex) ? m_iSelWnd : iWndIndex;
      let oPromise = new Promise((resolve, reject) => {
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(iWndIndex);
        if (iIndex != -1) {
    ...
    window.I_SetVolume = function (iVolume, iWndIndex) {
      let oPromise = new Promise((resolve, reject) => {
        var iRet = -1;
    ...
    window.I_CapturePic = function (szPicName, options) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_CapturePicData = function (options) {
      let oPromise = new Promise((resolve, reject) => {
        var newOptions = { iWndIndex: m_iSelWnd, bDateDir: true };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_StartRecord = function (szFileName, options) {
      let oPromise = new Promise((resolve, reject) => {
        var newOptions = { iWndIndex: m_iSelWnd, bDateDir: true };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_StopRecord = function (options) {
      let oPromise = new Promise((resolve, reject) => {
        var newOptions = { iWndIndex: m_iSelWnd };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_StartVoiceTalk = function (szDeviceIdentify, iAudioChannel) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_StopVoiceTalk = function () {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_StartAudioPlay = function (szDeviceIdentify, options) {
      let oPromise = new Promise((resolve, reject) => {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_StopAudioPlay = function () {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_PTZControl = function (iPTZIndex, bStop, options) {
      let oPromise = new Promise((resolve, reject) => {
        var newOptions = {
          iWndIndex: m_iSelWnd,
          iPTZIndex: iPTZIndex,
        ...
        if (iIndex != -1) {
          var wndInfo = m_wndSet[iIndex];
          iIndex = m_webVideoCtrl.findDeviceIndexByIP(wndInfo.szIP);
          if (iIndex != -1) {
            var oDeviceInfo = m_deviceSet[iIndex];
            if (9 == iPTZIndex) {
              oDeviceInfo.oProtocolInc
    ...
    window.I_EnableEZoom = function (iWndIndex) {
      let oPromise = new Promise((resolve, reject) => {
        iWndIndex = m_utilsInc.isUndefined(iWndIndex) ? m_iSelWnd : iWndIndex;
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(iWndIndex);
        if (iIndex != -1) {
    ...
    window.I_DisableEZoom = function (iWndIndex) {
      let oPromise = new Promise((resolve, reject) => {
        iWndIndex = m_utilsInc.isUndefined(iWndIndex) ? m_iSelWnd : iWndIndex;
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(iWndIndex);
        if (iIndex != -1) {
    ...
    window.I_Enable3DZoom = function (iWndIndex) {
      let oPromise = new Promise((resolve, reject) => {
        iWndIndex = m_utilsInc.isUndefined(iWndIndex) ? m_iSelWnd : iWndIndex;
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(iWndIndex);
        if (iIndex != -1) {
    ...
    window.I_Disable3DZoom = function (iWndIndex) {
      let oPromise = new Promise((resolve, reject) => {
        iWndIndex = m_utilsInc.isUndefined(iWndIndex) ? m_iSelWnd : iWndIndex;
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(iWndIndex);
        if (iIndex != -1) {
    ...
    window.I_FullScreen = function (bFull) {
      let oPromise = new Promise(function (resolve, reject) {
    ...
    window.I_SetPreset = function (iPresetID, options) {
      let oPromise = new Promise(function (resolve, reject) {
    ...
    window.I_GoPreset = function (iPresetID, options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd, iPresetID: iPresetID };
        m_utilsInc.extend(newOptions, options);
        var iIndex = m_webVideoCtrl.findWndIndexByIndex(newOptions.iWndIndex);
    ...
    window.I_RecordSearch = function (
      szDeviceIdentify,
      iChannelID,
      szStartTime,
      szEndTime,
    ...
    window.I_StartPlayback = function (szDeviceIdentify, options) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify),
          cgi = "",
          urlProtocol = "",
    ...
    window.I_ReversePlayback = function (szDeviceIdentify, options) {
      let oPromise = new Promise(function (resolve, reject) {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify),
          iRet = -1,
          cgi = "",
    ...
    window.I_Frame = function (options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_Pause = function (options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_Resume = function (options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_PlaySlow = function (options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_PlayFast = function (options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_GetOSDTime = function (options) {
      let oPromise = new Promise(async function (resolve, reject) {
        var newOptions = { iWndIndex: m_iSelWnd };
        if (m_utilsInc.isObject(options)) {
          m_utilsInc.extend(newOptions, options);
    ...
    window.I_StartDownloadRecord = function (
      szDeviceIdentify,
      szPlaybackURI,
      szFileName,
      options
    ...
    window.I_StartDownloadRecordByTime = function (
      szDeviceIdentify,
      szPlaybackURI,
      szFileName,
      szStartTime,
    ...
    window.I_GetDownloadStatus = function (iDownloadID) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_GetDownloadProgress = function (iDownloadID) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_StopDownloadRecord = function (iDownloadID) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_ExportDeviceConfig = function (szDeviceIdentify) {
      let oPromise = new Promise((resolve, reject) => {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_ImportDeviceConfig = function (szDeviceIdentify, szFileName) {
      let oPromise = new Promise((resolve, reject) => {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_RestoreDefault = function (szDeviceIdentify, szMode, options) {
      let oPromise = new Promise((resolve, reject) => {
        var newOptions = { success: null, error: null };
        m_utilsInc.extend(newOptions, options);
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
    ...
    window.I_Restart = function (szDeviceIdentify, options) {
      let oPromise = new Promise((resolve, reject) => {
        var newOptions = { success: null, error: null };
        m_utilsInc.extend(newOptions, options);
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
    ...
    window.I_Reconnect = function (szDeviceIdentify, options) {
      let oPromise = new Promise((resolve, reject) => {
        var newOptions = { success: null, error: null };
        m_utilsInc.extend(newOptions, options);
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
    ...
    window.I_StartUpgrade = function (szDeviceIdentify, szFileName) {
      let oPromise = new Promise((resolve, reject) => {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    window.I_UpgradeStatus = function (szDeviceIdentify) {
      let oPromise = new Promise((resolve, reject) => {
        window.I_SendHTTPRequest(
          szDeviceIdentify,
    ...
    window.I_UpgradeProgress = function (szDeviceIdentify) {
      let oPromise = new Promise((resolve, reject) => {
        window.I_SendHTTPRequest(
          szDeviceIdentify,
          m_ISAPIProtocol.CGI.startUpgrade.status,
    ...
    window.I_CheckPluginInstall = function () {
      return true;
    };
    window.I_CheckPluginVersion = function () {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_SendHTTPRequest = function (szDeviceIdentify, szURI, options) {
      let oPromise = new Promise(async function (resolve, reject) {
    ...
    window.I_ChangeWndNum = function (iWndType) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_GetLastError = function () {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_GetWindowStatus = function (iWndIndex) {
      if (m_utilsInc.isUndefined(iWndIndex)) {
        var wndSet = [];
        m_utilsInc.extend(wndSet, m_wndSet);
        return wndSet;
      } else {
        var i = m_webVideoCtrl.findWndIndexByIndex(iWndIndex);
        if (i != -1) {
          var wndSet = {};
    ...
    window.I_GetIPInfoByMode = function (iMode, szAddress, iPort, szDeviceInfo) {
      return;
    };
    window.I_SetPlayModeType = function (iMode) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_SetSnapDrawMode = function (iWndIndex, iMode) {
      let bType = false;
      if (iMode !== -1) {
        bType = true;
      }
    ...
    window.I_SetSnapPolygonInfo = function (iWndIndex, szInfo) {
      let oPromise = new Promise((resolve, reject) => {
        var aP = [];
    ...
    window.I_GetSnapPolygonInfo = function (iWndIndex) {
      let oPromise = new Promise((resolve, reject) => {
        var aP = [];
    ...
    window.I_ClearSnapInfo = function (iWndIndex, aShapes) {
      let oPromise = new Promise((resolve, reject) => {
        if (aShapes) {
          var aPolygon = [];
          var aRect = [];
    ...
    window.I_DeviceCapturePic = function (
      szDeviceIdentify,
      iChannelID,
      szPicName,
      options
    ...
    window.I_SetPackageType = function (iPackageType) {
      let oPromise = new Promise((resolve, reject) => {
    ...
    window.I_GetDevicePort = function (szDeviceIdentify) {
      let oPromise = new Promise(async (resolve, reject) => {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        var oPort = null;
        if (iIndex != -1) {
    ...
    window.I_GetTextOverlay = function (szUrl, szDeviceIdentify, options) {
      let oPromise = new Promise((resolve, reject) => {
        var iIndex = m_webVideoCtrl.findDeviceIndexByIP(szDeviceIdentify);
        if (iIndex != -1) {
          var oDeviceInfo = m_deviceSet[iIndex];
    ...
    m_webVideoCtrl.findDeviceIndexByIP = function (szDeviceIdentify) {
    ...
    m_webVideoCtrl.findWndIndexByIndex = function (iWndIndex) {
      ...
      let oPromise = new Promise(function (resolve, reject) {
        ...
        m_utilsInc.extend(newOptions, {
          success: function (xmlDoc) {
            ...
            //   .eq(0)
            //   .text();
            oDeviceInfo.szDeviceType="ITCCAM";
            var arrXml = [];
            ...
            arrXml.push(
              "<deviceID>" +
                ...
                "e32e6863-ea5e-4ee4-997e-ITCCAM"+
                "</deviceID>"
            );
            arrXml.push(
              "<deviceType>" +
            ...
            arrXml.push(
              "<serialNumber>" +
                ...
                "iDS-2CD9856-FES 20221123AIK96683299"+
                "</serialNumber>"
            );
            arrXml.push(
              "<macAddress>" +
      ...
      let oPromise = new Promise(function (resolve, reject) {
        ...
        m_utilsInc.extend(newOptions, {
          success: function (xmlData) {
            ...
            oDeviceInfo.iAnalogChannelNum =1;
             var len=1;
            // for (var i = 0, iLen = nodeList.length; i < iLen; i++) {
  ...
  // const NS = (this.WebVideoCtrl = WebVideoCtrl);
  const NS=WebVideoCtrl;
