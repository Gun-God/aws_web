<template>
  <div class="tableDiv">
      ...
      <card>
        ...
        <div class="inputFormBody">
          ...
          >
            ...
            <FormItem label="货物名称：" prop="name">
              <Input placeholder="请输入称重时间" v-model="time" />
            </FormItem>
            ...
            <FormItem label="操作员：" prop="name">
              <Input placeholder="请输入称重时间" v-model="time" />
            </FormItem>

            <FormItem label="复检员：" prop="name">
              <Input placeholder="请输入称重时间" v-model="time" />
            </FormItem>

            <FormItem>
              <Button  @click="addPerson('employeeForm')"
                >新增</Button>
    ...
    <div class="leftMsgDiv">

         <div class="center-content">
          <div class="content-left">
<!-- 车牌 车型 车道 初检重量 限重 初检时间 流水号 初检车速-->
            <p>流水号:</p>
            <p>初检重量:</p>
            <p>限重:</p>
            <p>初检车速:</p>
...
export default {
      ...
      columns1: [
        ...
        // },
        {
          ...
          render: (h, params) => {
            ...
            // console.info(data)
            if (data === 0) return h("span", "登录日志");
            else return h("span", "操作日志");
          },
        },
        {
          title: "日志内容",
  ...
  methods: {
    getUserLogList() {
      getUserLogList(this.current, this.pageSize)
        .then((res) => {
